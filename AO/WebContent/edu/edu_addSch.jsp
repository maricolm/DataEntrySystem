...
<div class="am-cf admin-main">
  ...
  <div class="admin-sidebar">
    <ul class="am-list admin-sidebar-list">
      ...
      <li  style="background: #0e90d2;"><a href="edu_addSch.jsp" style="color:white;"><span class="am-icon-pencil-square-o"></span>&nbsp;添加用户</a></li>
    </ul>
  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form action="<c:url value='/edu/addSch.do'/>" class="am-form am-form-horizontal">
        	<div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">账号 / Account</label>
            <div class="am-u-sm-9">
              <input class="test" id="inAccount" name="sAccount" type="text" id="user-name" placeholder="账号 / Account">
              <small id="inAccountError">账号为用户登录凭证，初试密码为：000000。</small>
            </div>
          </div>
          <div class="am-form-group">
            <label for="user-QQ" class="am-u-sm-3 am-form-label">学校名称</label>
            <div class="am-u-sm-9">
              <input  class="test"  name="sName" type="text" id="sName" placeholder="学校名称 / school">
              <small>输入用户所在的学校</small>
            </div>
          </div>
          <div class="am-form-group">
            <label for="user-QQ" class="am-u-sm-3 am-form-label">部门</label>
            <div class="am-u-sm-9">
              <input  class="test"  name="sDepartment" type="text" id="sDepartment" placeholder="部门 / Department">
              <small>输入用户所在的部门</small>
            </div>
          </div>
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">姓名 / Name</label>
            <div class="am-u-sm-9">
              <input  class="test"  name="sUname" type="text" id="sUname" placeholder="姓名 / Name">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input  class="test"  name="sEmail" type="email" id="sEmail" placeholder="输入你的电子邮件 / Email">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input  class="test"  name="sPhone" type="tel" id="sPhone" placeholder="输入你的电话号码 / Telephone">
