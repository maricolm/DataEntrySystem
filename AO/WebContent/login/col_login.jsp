...
<div class="top">
  <ul>
    ...
    <li><a href="javascript:void(0)" class="hover">二级学院账号登录</a></li>
  </ul>
</div>
...
<div class="main">
  <div class="denglu">
    ...
    <div class="dlk">
    <form action="${pageContext.request.contextPath }/col/login.do"  method="post">
      <table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="76" colspan="3" style="text-align: center;color: #000000;font-size: 18px;">学院账号登录入口</td>
        </tr>
        <tr>
          <td width="65" style="font-size:14px;">登录账号</td>
          <td colspan="2"><input name="cAccount" id="account" type="text" class="dlinput" /><span id="accountError" class="tips">&nbsp;</span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td>登录密码</td>
          <td colspan="2"><input name="cPswd" id="pswd" type="password" class="dlinput" /><span id="pswdError" class="tips">&nbsp;</span></td>
        </tr>
        <tr>
          <td height="16" colspan="3"></td>
        </tr>
