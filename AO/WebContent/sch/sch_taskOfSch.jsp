           ...
           <tr>
              ...
              <td>
                <div class="am-btn-toolbar">
                  ...
                  <c:choose>
                  	<c:when test="${tPro.tPState==1 }">
                  	<a href="${pageContext.request.contextPath }/sch/assignTaskToCol.do?currentPage=${pb.currentPage }&tid=${tPro.tId }&pid=${tPro.pId}" class="am-btn am-btn-default am-btn-xs am-text-success" onclick="return confirm('确认分发？')"><span class="am-icon-adn "></span>&nbsp;分发任务</a>
                  	</c:when>
                  	<c:when test="${tPro.tState==5 }">
                  	<font color="red">已驳回：${tPro.backMsg }</font>
                  	</c:when>
                  	<c:otherwise>
