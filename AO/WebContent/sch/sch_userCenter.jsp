  ...
  <div class="am-tabs am-margin" data-am-tabs>
    ...
    <div class="am-tabs-bd">
      <div class="am-tab-panel am-fade am-in am-active" id="tab1">
        <form action="<c:url value='/sch/modifyinfo.do'/>" method="post" class="am-form am-form-horizontal">
        	<input name="sId" type="hidden" value="${sch.sId }">
        	<div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">学校名称 / School</label>
            <div class="am-u-sm-4 am-u-end">
              <input name="sName" type="text" id="user-name" disabled="disabled" value="${sch.sName }">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input name="sAccount" type="text" id="user-name" disabled="disabled" value="${sch.sAccount }">
              <small>账号为统一分配，同时为登录凭证，不可修改。</small>
            </div>
          </div>
          <div class="am-form-group">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input name="sUname" type="text" id="user-name" value="${sch.sUname }">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input name="sEmail" type="email" id="user-email" value="${sch.sEmail }">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input name="sPhone" type="text" id="user-phone" value="${sch.sPhone }">
              <small>输入你常用的电话号码</small>
            </div>
          </div>

          <div class="am-form-group">
            <label for="user-QQ" class="am-u-sm-3 am-form-label">部门 / Department</label>
            <div class="am-u-sm-4 am-u-end">
              <input name="sDepartment" type="text" id="user-QQ" value="${sch.sDepartment }">
      ...
      <div class="am-tab-panel am-fade" id="tab3">
        <form  action="<c:url value='/sch/modifypswd.do'/>" method="post" class="am-form">
          ...
          <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-4 am-u-end">
              <input name="pwsd" type="password" id="rnpswd" class="am-input-sm"><small id="rnpswdError" style="color: red"></small>
            </div>
          </div>
          <div class="am-g am-margin-top-sm">
