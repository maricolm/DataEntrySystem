...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>快速访问</small></div>
    </div>
    <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
      <li><a href="#" class="am-text-success"><span class="am-icon-btn am-icon-file-text"></span><br/>待完成项目列表<br/>1</a></li>
      <li><a href="#" class="am-text-danger"><span class="am-icon-btn am-icon-recycle"></span><br/>用户列表<br/></a></li>
      <li><a href="#" class="am-text-warning"><span class="am-icon-btn am-icon-briefcase"></span><br/>帮助<br/>使用指南</a></li>
      <li><a href="${pageContext.request.contextPath}/col/col_userCenter.jsp" class="am-text-secondary"><span class="am-icon-btn am-icon-user-md"></span><br/>个人中心<br/></a></li>
    </ul>
  </div>
  <!-- content end -->
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"></strong> <small>备注：</small></div>
    </div>
    <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
			请按照使用指南使用本系统。以防您的操作不当而销毁数据！
    </ul>
