 ...
 * @author mulming
 * @time 2018年5月25日
 * @descript MailTestForAliYunExample
 */
 ...
 //阿里SMTP服务器地址
    ...
    public static void main(String[] args) throws MessagingException {
       ...
       // props.put("mail.smtp.port", ALIDM_SMTP_PORT);   
        ...
        // 发件人的账号
        props.put("mail.user", "muliming@aliyun.com");
        // 访问SMTP服务时需要提供的密码(邮箱密码)
        props.put("mail.password", "mu001770ming");
        ...
        // 设置收件人
        InternetAddress to = new InternetAddress("578222621@qq.com");
